"""Support helpers for composition targeting, scoring, and contract text.

These helpers are intentionally kept separate from `composition_service.py` so the
main service reads like an execution pipeline rather than a long list of semantic
